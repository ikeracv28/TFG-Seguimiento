...
---
*Este proyecto forma parte del Trabajo de Fin de Grado en Ingeniería Informática.*

## ??? Backend (Spring Boot)
Este m�dulo gestiona la API REST, la seguridad JWT y la persistencia de datos.
## ?? Frontend (Flutter)
Este m�dulo contiene la interfaz multiplataforma para el seguimiento de las pr�cticas.
